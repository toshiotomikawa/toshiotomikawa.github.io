...
- Keep private review notes in `C:\Users\Zen\Desktop\Coding\Portfolio\archive`, beside the repository checkout at `Portfolio\main`. Record the notes location and checkpoint status without private content in AGENTS.md. Full backups mirror the entire `Portfolio` folder, `archive` included, to the G: and W: destinations listed in AGENTS.md.
