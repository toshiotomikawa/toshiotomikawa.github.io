...
## Current checkpoint
- Phase 1 drafted and verified on 2026-09-15. Phase 2 third Claude direction is ready for visual review: dark, typographic, asymmetric, with restrained orange markers. User rejected the beige/serif and plain white versions. User approved this direction conditional on System/Light/Dark selection; theme control implemented and cycle/navigation/reload checked in Claude. Local implementation and full verification remain pending.
...
- Current work: Claude Design prototype at https://claude.ai/design/p/5e5efd6b-f73c-4ce4-baac-cab1fdf8a15d . Claude homepage and MGS case are generated in EN/PT. Manually checked language switching, case navigation, return home, and desktop/mobile preview. Visual direction now approved with theme control; next checkpoint is local prototype integration and verification within Phase 2. Automatic detection, no-JS behavior, production routes, and full accessibility are not yet verified. GitHub Pages deploys from main/root; do not push prototype code there before launch authorization.
