...
- Current work: Claude Design prototype at https://claude.ai/design/p/5e5efd6b-f73c-4ce4-baac-cab1fdf8a15d . Claude homepage and MGS case are generated in EN/PT. Manually checked language switching, case navigation, return home, and desktop/mobile preview. Pause for visual feedback before local integration; remain in Phase 2. Automatic detection, no-JS behavior, production routes, and full accessibility are not yet verified. GitHub Pages deploys from main/root; do not push prototype code there before launch authorization.
